  ...
  <div class="section">
    <div class="content-container container content">
      ...
      <p>
        ...
        Definitionen
        im Art. 4 der Datenschutzgrundverordnung (DSGVO). <br>
        <br>
      </p>
      ...
      <p>
        <span class="tsmcontroller">Linus Boehm<br>
          Spixstraße 35<br>
          81539 München<br>
          017656719690<br>
          <br>
          letters@linusboehm.de<br>
          https://linusboehm.de/impressum</span>
      </p>
      ...
      <p>
        ...
        Daten
        an Dritte, wie an Zahlungsdienstleister, zur Vertragserfüllung erforderlich ist), Nutzer eingewilligt haben,
        eine
      ...
      <p>
        ...
        "Privacy-Shield"
        zertifizierten US-Verarbeiter gehören oder auf Grundlage besonderer Garantien, wie z.B. vertraglicher
        Verpflichtung durch sogenannte Standardschutzklauseln der EU-Kommission, dem Vorliegen von Zertifizierungen oder
        verbindlichen internen Datenschutzvorschriften verarbeiten (Art. 44 bis 49 DSGVO, <a
      ...
      <p>
        <strong>Sie können der künftigen Verarbeitung der Sie betreffenden Daten nach Maßgabe der gesetzlichen Vorgaben
      ...
      <p>
        ...
        die
        für Reichweitenmessung oder Marketingzwecke verwendet werden. Als „Third-Party-Cookie“ werden Cookies
        bezeichnet,
        ...
        >http://www.youronlinechoices.com/</a> erklärt werden. Des Weiteren kann
      ...
      <p />
      <p>
        <span class="ts-muster-content">Wir nutzen die von Google angebotene Cloud und die Cloud-Softwaredienste (sog. Software as a Service, z.B. Google Suite) für die folgenden Zwecke: Dokumentenspeicherung und Verwaltung, Kalenderverwaltung, E-Mail-Versand, Tabellenkalkulationen und Präsentationen, Austausch von Dokumenten, Inhalten und Informationen mit bestimmten Empfängern oder Veröffentlichung von Webseiten, Formularen oder sonstigen Inhalten und Informationen sowie Chats und Teilnahme an Audio- und Videokonferenzen.<br>
          <br>
          ...
          <br>
          Wir nutzen die Google Cloud-Dienste auf Grundlage unserer berechtigten Interessen gem. Art. 6 Abs. 1 lit. f DSGVO an effizienten und sicheren Verwaltungs- und Zusammenarbeitsprozessen. Ferner erfolgt die Verarbeitung auf Grundlage eines Auftragsverarbeitungsvertrages mit Google (<a
            target="_blank"
          ...
          >https://cloud.google.com/security/privacy/</a>). Sie können der Verarbeitung Ihrer Daten in der Google Cloud uns gegenüber entsprechend den gesetzlichen Vorgaben widersprechen. Im Übrigen bestimmt sich die Löschung der Daten innerhalb von Googles Cloud-Diensten nach den übrigen Verarbeitungsprozessen in deren Rahmen die Daten verarbeitet werden (z.B., Löschung für Vertragszwecke nicht mehr erforderlicher oder Speicherung für Zwecke der Besteuerung erforderlicher Daten).<br>
          <br>
          Die Google Cloud-Dienste werden von Google Irland Limited angeboten. Soweit eine Übermittlung in die USA stattfindet, verweisen wir auf die Zertifizierung von Google USA unter dem Privacy Shield(<a
            target="_blank"
      ...
      <p />
      <h3 id="dsg-microsoft-cloud">
        Microsoft Cloud-Dienste
      </h3>
      <p />
      <p>
        <span class="ts-muster-content">Wir nutzen die von Microsoft angebotene Cloud und die Cloud-Softwaredienste (sog. Software as a Service, z.B. Microsoft Office) für die folgenden Zwecke: Dokumentenspeicherung und Verwaltung, Kalenderverwaltung, E-Mail-Versand, Tabellenkalkulationen und Präsentationen, Austausch von Dokumenten, Inhalten und Informationen mit bestimmten Empfängern oder Veröffentlichung von Webseiten, Formularen oder sonstigen Inhalten und Informationen sowie Chats und Teilnahme an Audio- und Videokonferenzen.<br>
          <br>
          Hierbei werden die personenbezogenen Daten der Nutzer verarbeitet, soweit diese Bestandteil der innerhalb&nbsp; der beschriebenen Dienste verarbeiteten Dokumente und Inhalte werden oder Teil von Kommunikationsvorgängen sind. Hierzu können z.B. Stammdaten und Kontaktdaten der Nutzer, Daten zu Vorgängen, Verträgen, sonstigen Prozessen und deren Inhalte gehören. Microsoft verarbeitet ferner Nutzungsdaten und Metadaten, die von Microsoft zu Sicherheitszwecken und Serviceoptimierung verwendet werden.<br>
          <br>
          Im Rahmen der Nutzung öffentlich zugängliche Dokumente, Webseiten oder sonstige Inhalte, kann Microsoft Cookies auf den Rechner der Nutzer für Zwecke der Webanalyse oder um sich Einstellungen der Nutzer zu merken, speichern.<br>
          <br>
          Wir nutzen die Microsoft Cloud-Dienste auf Grundlage unserer berechtigten Interessen gem. Art. 6 Abs. 1 lit. f DSGVO an effizienten und sicheren Verwaltungs- und Zusammenarbeitsprozessen. Ferner erfolgt die Verarbeitung auf Grundlage eines Auftragsverarbeitungsvertrages mit Microsoft.<br>
          <br>
          Weitere Hinweise erhalten Sie in der Datenschutzerklärung von Microsoft (<a
            target="_blank"
            href="https://privacy.microsoft.com/de-de/privacystatement"
          >https://privacy.microsoft.com/de-de/privacystatement</a>) und den Sicherheitshinweisen zu Microsoft Cloud-Diensten (<a
            target="_blank"
            href="https://www.microsoft.com/de-de/trustcenter"
          >https://www.microsoft.com/de-de/trustcenter</a>). Sie können der Verarbeitung Ihrer Daten in der Microsoft Cloud uns gegenüber entsprechend den gesetzlichen Vorgaben widersprechen. Im Übrigen bestimmt sich die Löschung der Daten innerhalb von Microsofts Cloud-Diensten nach den übrigen Verarbeitungsprozessen in deren Rahmen die Daten verarbeitet werden (z.B., Löschung für Vertragszwecke nicht mehr erforderlicher oder Speicherung für Zwecke der Besteuerung erforderlicher Daten).<br>
          <br>
          Die Microsoft Cloud-Dienste werden von Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399 USA angeboten. Soweit eine Verarbeitung von Daten in die USA stattfindet, verweisen wir auf die Zertifizierung von Microsoft unter dem Privacy Shield (<a
            target="_blank"
            href="https://www.privacyshield.gov/participant?id=a2zt0000000KzNaAAK&amp;status=Active"
          >https://www.privacyshield.gov/participant?id=a2zt0000000KzNaAAK&amp;status=Active</a>).</span>
      </p>
      <p />
      ...
      <p />
      <p>
        <span class="ts-muster-content">Wir setzen auf Grundlage unserer berechtigten Interessen (d.h. Interesse an der Analyse, Optimierung und wirtschaftlichem Betrieb unseres Onlineangebotes im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) Google Analytics, einen Webanalysedienst der Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland („Google“) ein. Google verwendet Cookies. Die durch das Cookie erzeugten Informationen über Benutzung des Onlineangebotes durch die Nutzer werden in der Regel an einen Server von Google in den USA übertragen und dort gespeichert.<br>
          <br>
      ...
      <p />
      <p>
        <span class="ts-muster-content">Wir binden die Videos der Plattform “YouTube” des Anbieters Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, ein. Datenschutzerklärung: <a
          target="_blank"
          href="https://www.google.com/policies/privacy/"
